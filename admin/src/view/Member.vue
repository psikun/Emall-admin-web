  ...
  <container>
    ...
    <el-form :inline="true" :model="query" ref="query" class="goods_query_form">
      <el-form-item prop="id">
        <el-input v-model.number="query.id" placeholder="会员ID"/>
      </el-form-item>
      <el-form-item prop="status">
        <el-input v-model.number="query.name" placeholder="会员名称"/>
      </el-form-item>
      <!--      <el-form-item prop="status">-->
      <!--        <el-select v-model="query.status" placeholder="会员状态">-->
...
<!--        <el-button type="primary" :icon="Plus" @click="add">活动</el-button>-->
    ...
    <!-- 活动列表 -->
    <el-table :data="memberList" height="65vh" style="width: 100%">
      <el-table-column prop="id" label="会员ID" min-width="50">
      </el-table-column>
      ...
      <el-table-column prop="address" label="收货地址" min-width="50">
        <template >
          <el-button size="medium" type="danger">收货地址</el-button>
        </template>
      </el-table-column>
...
import {Brush, Minus, Plus, Search, WarningFilled} from "@element-plus/icons-vue";
